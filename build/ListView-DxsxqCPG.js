import{j as e,d as b,$ as p,e7 as O,k as A,F as x,T as k,c as be,f as R,av as L,I as U,a as ye,a6 as je,fD as Ce,bH as Y,aV as Z,a3 as K,fE as we,b as Q,bm as Te,bt as $e,bu as ve,cx as ke,b7 as De,p as ee,as as Me,n as Re,D as B,cD as Fe,V as Se,z as Ae,eC as Ee,b9 as Ie,aB as _,fF as Le,B as te}from"./strapi-C-eRo5uk.js";import{u as D,g as m,C as J,a as W,A as Oe,S as Ne,c as X}from"./index-P0iR-7IT.js";import{d as Ue,e as Be,D as Pe,f as ze,a as Ve,S as Ze,v as We,P as He,c as qe,C as Ge}from"./sortable.esm-B2azNJXf.js";import"./groupBy-Rx9mznxE.js";import"./_baseEach-C6jXJlJS.js";import"./sortBy-EPpgsn76.js";import"./_baseMap-UJwXX86S.js";import"./index-xqi9q7sH.js";import"./index-BRVyLNfZ.js";const _e=t=>{let{transform:n}=t;return{...n,x:0}},Je=b(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,bt=R.memo(({disabled:t,type:n})=>{const{formatMessage:o}=A(),s=Se(),l=ft(n),r=o({id:"content-type-builder.form.button.configure-view",defaultMessage:"Configure the view"}),i=()=>{if(t)return!1;const y=ht(n);return s(y),!1},{isLoading:c,allowedActions:f}=Ae(l);return c||!f.canConfigureView&&!f.canConfigureLayout?null:e.jsx(xt,{startIcon:e.jsx(Ee,{}),variant:"tertiary",onClick:i,disabled:t,children:r})}),yt=b(te.Header)`
  ...
  white-space: nowrap;
`,Rt=()=>{const{isInDevelopmentMode:t,contentTypes:n,components:o,isLoading:s}=D(),{formatMessage:l}=A(),{trackUsage:r}=ee(),{contentTypeUid:i,componentUid:c}=Ie(),{onOpenModalAddComponentsToDZ:f,onOpenModalAddField:y,onOpenModalEditSchema:v}=W(),a=i?n[i]:c?o[c]:null;if(s)return null;if(!a){const j=Object.values(n).filter(C=>C.visible===!0&&!C.plugin).map(C=>C.uid).sort();return j.length>0?e.jsx(_,{to:`/plugins/content-type-builder/content-types/${j[0]}`}):e.jsx(_,{to:"/plugins/content-type-builder/content-types/create-content-type"})}const d="plugin"in a&&a?.plugin!==void 0,u=i?"contentType":"component",w=a?.info?.displayName??"",T=t&&!d,F=j=>{f({dynamicZoneTarget:j,targetUid:a.uid})},M=()=>{if("kind"in a){a?.kind==="collectionType"&&r("willEditNameOfContentType"),a?.kind==="singleType"&&r("willEditNameOfSingleType"),v({modalType:u,forTarget:u,targetUid:a.uid,kind:a?.kind});return}v({modalType:u,forTarget:u,targetUid:a.uid})},E=l({id:m("table.button.no-fields"),defaultMessage:"Add new field"}),S=l({id:m("button.attributes.add.another"),defaultMessage:"Add another field"}),g=a.status==="REMOVED",h=t&&e.jsxs(x,{gap:2,children:[e.jsx(bt,{type:a,disabled:a.status==="NEW"||g},"link-to-cm-settings-view"),e.jsx(B,{startIcon:e.jsx(Q,{}),variant:"tertiary",onClick:M,disabled:!T||g,children:l({id:"app.utils.edit",defaultMessage:"Edit"})}),e.jsx(B,{startIcon:e.jsx(L,{}),variant:"secondary",minWidth:"max-content",onClick:()=>{y({forTarget:u,targetUid:a.uid})},disabled:g,children:a.attributes.length===0?E:S})]});return e.jsxs(e.Fragment,{children:[g&&e.jsx(x,{background:"danger100",justifyContent:"center",padding:4,children:e.jsxs(x,{gap:2,children:[e.jsx(Le,{fill:"danger600",height:"2rem",width:"2rem"}),e.jsx(k,{children:l({id:m("table.warning.deleted"),defaultMessage:"This {kind} has been deleted"},{kind:a.modelType==="contentType"?"Content Type":"Component"})})]})}),e.jsx(yt,{id:"title",primaryAction:h,title:Z(w)}),e.jsx(te.Content,{children:e.jsx(p,{background:"neutral0",shadow:"filterShadow",hasRadius:!0,overflow:"auto",borderColor:"neutral150",children:e.jsx(le,{type:a,addComponentToDZ:F,isMain:!0})})})]})};export{Rt as default};
