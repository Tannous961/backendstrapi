"use strict";(self.webpackChunk=self.webpackChunk||[]).push([[4631],{4631:(dt,S,s)=>{s.r(S),s.d(S,{default:()=>Nt});var t=s(92132),_=s(52724),P=s(36726),X=s(73228),F=s(17060),w=s(82869),G=s(36531),m=s(44940),N=s(81888),j=s(40710),z=s(99690),I=s(19692),ct=s(61693),E=s(12248),d=s(1433),ht=s(46270),_t=s(54514),pt=s(68802),gt=s(77701),ut=s(41231),J=s(41909),W=s(5194),mt=s(50612),C=s(2600),Et=s(412),Y=s(56336),q=s(39404),R=s(54894),H=s(93884),L=s(21272),r=s(32224),f=s(16333),kt=s(14718),Zt=s(69314),Vt=s(48940),Xt=s(77160),wt=s(21835),Gt=s(17024),Ht=s(51187),Qt=s(12083),Jt=s(94710),Yt=s(14311),qt=s(82437),te=s(89102),ee=s(5409),se=s(35336),ne=s(71547),oe=s(58692),ae=s(71210),ie=s(5790),le=s(35223),re=s(45635);const ft=(0,f.Ay)(_.a)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,yt=({component:e,dzName:n,index:o,isActive:a=!1,isInDevelopmentMode:c=!1,onClick:l})=>{const{modifiedData:p,removeComponentFromDynamicZone:D}=(0,r.u)(),{schema:{icon:M,displayName:x}}=C(p,["components",e],{schema:{}}),g=i=>{i.stopPropagation(),D(n,o)};return(0,t.jsxs)(Mt,{alignItems:"center",direction:"column",className:a?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,onClick:l,role:"tab",tabIndex:a?0:-1,cursor:"pointer","aria-selected":a,"aria-controls":`dz-${n}-panel-${o}`,id:`dz-${n}-tab-${o}`,children:[(0,t.jsx)(xt,{icon:M,isActive:a}),(0,t.jsx)(_.a,{marginTop:1,maxWidth:"100%",children:(0,t.jsx)(E.o,{variant:"pi",fontWeight:"bold",ellipsis:!0,children:x})}),c&&(0,t.jsx)(st,{as:"button",onClick:g,children:(0,t.jsx)(pt.A,{})})]})},Ct=(0,f.Ay)(W.A)`
  width: ${(0,d.a8)(32)};
  height: ${(0,d.a8)(32)};
  padding: ${(0,d.a8)(9)};
...
`,Pt=(0,f.Ay)(m.s)`
  ...
  align-items: center;
`,vt=({customRowComponent:e,components:n=[],addComponent:o,name:a,targetUid:c})=>{const{isInDevelopmentMode:l}=(0,r.u)(),[p,D]=(0,L.useState)(0),{formatMessage:M}=(0,R.A)(),x=i=>{p!==i&&D(i)},g=()=>{o(a)};return(0,t.jsx)(tt,{className:"dynamiczone-row",isFromDynamicZone:!0,children:(0,t.jsxs)("td",{colSpan:12,children:[(0,t.jsx)(Dt,{paddingLeft:8,children:(0,t.jsxs)(jt,{gap:2,children:[l&&(0,t.jsx)("button",{type:"button",onClick:g,children:(0,t.jsxs)(Pt,{direction:"column",alignItems:"stretch",gap:1,children:[(0,t.jsx)(Ct,{}),(0,t.jsx)(E.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:M({id:(0,r.g)("button.component.add"),defaultMessage:"Add a component"})})]})}),(0,t.jsx)(m.s,{role:"tablist",gap:2,children:n.map((i,h)=>(0,t.jsx)(yt,{dzName:a||"",index:h,component:i,isActive:p===h,isInDevelopmentMode:l,onClick:()=>x(h)},i))})]})}),(0,t.jsx)(Ot,{children:n.map((i,h)=>{const u={customRowComponent:e,component:i};return(0,t.jsx)(_.a,{id:`dz-${a}-panel-${h}`,role:"tabpanel","aria-labelledby":`dz-${a}-tab-${h}`,style:{display:p===h?"block":"none"},children:(0,t.jsx)("table",{children:(0,t.jsx)("tbody",{children:(0,L.createElement)(et,{...u,isFromDynamicZone:!0,component:c,key:i})})})},i)})})]})})},At=(0,f.Ay)(_.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
...
`,m=(0,_.Ay)(P.a)`
  ...
  width: 100%;
  border: none;
`,N=({children:j,icon:z,...I})=>(0,t.jsxs)("div",{children:[(0,t.jsx)(X.c,{}),(0,t.jsx)(m,{as:"button",background:"primary100",padding:5,...I,children:(0,t.jsxs)(F.s,{children:[(0,t.jsx)(G,{"aria-hidden":!0,background:"primary200",children:z}),(0,t.jsx)(P.a,{paddingLeft:3,children:(0,t.jsx)(w.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:j})})]})})]})}}]);
